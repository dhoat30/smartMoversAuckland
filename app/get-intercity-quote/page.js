...
export async function generateMetadata(props, parent) {
    ...
    // fetch data
    const data = await getSinglePostData( 'get-intercity-quote', '/wp-json/wp/v2/pages')
  ...
  export default async function Home() {
    ...
    return (
        <>
            <Header />
            <main>
            <Layout googleReviewsData={googleReviews}  sections={sections} uspData={options.usp} statsData={options.status} locationsCovered={options.locations_covered} hoursCalculatorData={options.hours_calculator} spaceCalculatorData={options.cubic_meter_calculator} />
