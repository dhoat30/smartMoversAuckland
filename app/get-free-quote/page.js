  ...
  export default async function Home() {
    ...
    return (
        <>
            <Header />
            <main>
            <Layout sections={sections} uspData={options.usp} statsData={options.status} locationsCovered={options.locations_covered} hoursCalculatorData={options.hours_calculator} googleReviewsData={googleReviews} />
